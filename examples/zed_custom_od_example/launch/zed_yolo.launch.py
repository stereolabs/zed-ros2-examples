...
def launch_setup(context, *args, **kwargs):
    ...
    # Custom OD YOLO processing component
    zed_yolo_component = ComposableNode(
        package='zed_custom_od_example',
        namespace=camera_name_val,
...
def generate_launch_description():
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                'custom_od_node_name',
                default_value='zed_yolo_node',
                description='The name of the Custom OD inference node.'),
            DeclareLaunchArgument(
                'config_path',
            ...
            DeclareLaunchArgument(
                'rviz',
                default_value='true',
                description='Starts RVIZ2 preconfigured to show Custom OD detection results',
                choices=['true', 'false']),
